...
Канон того, **кто / когда / что / куда** пишет в shared-memory. **Версия v1.0** — утверждена Павлом 2026-04-29. Темы Telegram-групп подлежат финальному уточнению (Pavel пришлёт список) — это не блокирует версию правил.
